    ...
    <div style={{ display: "flex", gap: "1.5rem" }}>
      <aside style={{ width: 320, flexShrink: 0 }}>
        <div style={{ marginBottom: 12 }}>
          <Link to="/" style={{ color: "var(--fg-secondary)", fontSize: "0.85rem" }}>
            ← Назад
          </Link>
        </div>
        ...
        {/* Avatar greeting + nomination summaries — text editors + render
        ...
        {expectedTotal !== null && items !== null && items.length < expectedTotal && (
          ...
          >
            ...
            <div>
              ...
              <div style={{ color: "rgba(240,193,75,0.85)", fontSize: "0.75rem" }}>
          ...
          Date.now() - importedAt < 60_000 && (
            <div
              style={{
                marginBottom: 10,
                padding: "10px 12px",
                border: "1px solid rgba(94,224,192,0.45)",
                background: "rgba(94,224,192,0.10)",
                borderRadius: 6,
                fontSize: "0.85rem",
          ...
          <div style={{ marginBottom: 10 }}>
            <button
              ...
              style={{
                width: "100%",
                padding: "10px 12px",
                background: busy === "render-all" ? "rgba(255,255,255,0.18)" : "var(--fg-primary)",
                color: busy === "render-all" ? "var(--fg-secondary)" : "var(--fg-on-light)",
                border: "none",
                borderRadius: 6,
        ...
        {!items ? (
          ...
          <p style={{ color: "var(--fg-secondary)" }}>Кейсов нет. Загрузите JSON.</p>
        ) : (
                ...
                <li key={it.evaluation_id}>
                  ...
                  >
                    ...
                    <span style={{ display: "flex", gap: 6, flexWrap: "wrap", alignItems: "center" }}>
                      {it.nomination_code && (
                        <span style={{ fontSize: "0.7rem", color: "var(--fg-secondary)", fontWeight: 500 }}>
                          {it.nomination_code}
                        </span>
                      )}
                      <span
      ...
      <section style={{ flex: 1, minWidth: 0 }}>
        ...
        {!selected ? (
          <p style={{ color: "var(--fg-secondary)" }}>Выберите кейс слева, чтобы просмотреть, отредактировать речь или запустить рендер видео.</p>
        ) : (
              ...
              >
                ...
                {richVerdict.output.l2.criteria_scores.map((c) => (
                  ...
                  >
                    ...
                    <div style={{ minWidth: 60, color: "var(--fg-primary)", fontWeight: 700, fontSize: "0.95rem" }}>
                      {c.score?.toFixed(1)}
                    </div>
                    <div style={{ flex: 1, color: "var(--fg-secondary)", fontSize: "0.88rem", lineHeight: 1.5 }}>
                      {c.rationale}
                    </div>
                  </div>
                ))}
                {richVerdict.output.l2.caps_applied && richVerdict.output.l2.caps_applied.length > 0 && (
                  <div style={{ paddingTop: 10, borderTop: "1px dashed var(--border-subtle)", fontSize: "0.82rem", color: "var(--fg-secondary)" }}>
                    ...
                    <ul style={{ margin: "6px 0 0", paddingLeft: 18 }}>
                      {richVerdict.output.l2.caps_applied.map((cap, i) => (
                        <li key={i} style={{ marginBottom: 2 }}>
                          ...
                          <span style={{ color: "var(--fg-tertiary)" }}>({cap.reason})</span>
                        </li>
                      ))}
                    </ul>
                  </div>
